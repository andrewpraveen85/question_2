...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 bpatient-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                ...
                @endif
                <a href="{{ route('prescription.select', $prescription->id) }}" class="btn btn-sm btn-outline-secondary">Select</a>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-2">Date</div>
        <div class="col-md-2">{{date('Y-m-d',strtotime($payment->created_at))}}</div>
        <div class="col-md-2">Type</div>
        <div class="col-md-2">{{$payment->payment_type}}</div>
        <div class="col-md-2">Amount</div>
        <div class="col-md-2">{{number_format($payment->payment_amount, 2, '.', ',')}}</div>
    </div>
