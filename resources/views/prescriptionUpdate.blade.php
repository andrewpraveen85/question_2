...
@section('content')
    ...
    <h2>Update</h2>
    <form method="POST" action="{{ route('prescription.update.confirm') }}" enctype="multipart/form-data">
        @csrf <!-- {{ csrf_field() }} -->
        <div class="form-floating mb-3">
            <input type="date" class="form-control" id="floatingInput" name="prescription_date" placeholder="prescription_date" value="{{$prescription->prescription_date}}" required>
        ...
        <div class="form-floating mb-3">
            <textarea type="text" class="form-control" id="floatingInput" name="prescription_description" placeholder="prescription_description" required>{{$prescription->prescription_description}}</textarea>
        ...
        <div class="form-floating mb-3">
            <input type="number" step="100" min="100" class="form-control" id="floatingInput" name="prescription_price" placeholder="prescription_price" value="{{$prescription->prescription_price}}" required>
